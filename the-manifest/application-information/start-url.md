...
{% hint style="info" %}
The `start_url` is not translatable since version 1.3.0. If you need localized start URLs, use the `{locale}` placeholder in the manifest public URL configuration. See [Localisation & Translations](../translations.md) for more details.
{% endhint %}
